...
public class PlayerDash : MonoBehaviour
{
    ...
    IEnumerator DashRoutine() //quarentine is to b able to stop a process, do somthing else n come back later...
    {
        currentCharges--;
        ...
        while (elapsed < dashDuration)
        {
            ...
            yield return new WaitForFixedUpdate(); //giving control back to quarentine.. creo
        }
